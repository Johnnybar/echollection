	...
	render() {
		return (<View style={styles.ActionButtonContainer}>
			...
			<ActionButton radius={Platform.OS === "ios"
				? 100
				: 70} degrees={180} buttonColor="rgba(231,76,60,1)">
				<ActionButton.Item title="Empty" buttonColor='transparent' style={Platform.OS === "ios"
					? styles.hidden
					: styles.android}>
					<Icon name="ios-volume-off" style={Platform.OS === "ios"
						? styles.hidden
						: styles.android}/>
				</ActionButton.Item>
