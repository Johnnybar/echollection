    ...
    return !this.state.fontLoaded ? (
      ...
      <View style={styles.container}>
        ...
        <View style={styles.nameContainer}>
          <Text style={[styles.text, { fontFamily: 'Arial' }]}>
        ...
        <View
          ...
          <View style={styles.timestampRow}>
            <Text style={[styles.text, styles.buffering, { fontFamily: 'Arial' }]}>
              {this.state.isBuffering ? BUFFERING_STRING : ''}
            </Text>
            <Text style={[styles.text, styles.timestamp, { fontFamily: 'Arial' }]}>
              {this._getTimestamp()}
            </Text>
          </View>
        </View>
        ...
        <View style={[styles.buttonsContainerBase, styles.buttonsContainerBottomRow]}>
          <TouchableHighlight
            ...
            <View style={styles.button}>
              <Text style={[styles.text, { fontFamily: 'Arial' }]}>Rate:</Text>
            </View>
          </TouchableHighlight>
          <Slider
